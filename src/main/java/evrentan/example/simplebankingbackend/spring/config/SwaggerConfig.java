...
public class SwaggerConfig {
   ...
   */
  private static final String CONTROLLER_PATH = "evrentan.example.simplebankingbackend.controller";
  ...
  /**
   * Bean declaration for Swagger documentation details for all APIs within the {@link SwaggerConfig#CONTROLLER_PATH} field and matching "/account/**" end-points.
   *
   * @return GroupedOpenAPI. Please, see the {@link GroupedOpenApi} class for details.
   *
   * @author <a href="https://github.com/evrentan">Evren Tan</a>
